...
* MazeController
*
* Responsibilities: It implements a state-dependent behavior that  controls the display and reacts 
* to key board input from a user. At this point user keyboard input is first dealt with a key
* listener (SimpleKeyListener) and then handed over to a MazeController object by way of the keyDown method.
*
* Collaborators: Order, MazeConfiguration, BasicRobot, MazePanel, RobotDriver
* @author cssuh
*/
...
public class MazeController implements Order {
	...
	//TODO change constructors back to MazeFactory()
	...
	/**
	 * Constructor that selects a particular solver
	 * if there is no parameter set null should be passed in
	 * @param builder - either Prim's, Kruskal's, or DFS
	 * @param driver - either WallFollower or Wizard
	 */
	...
	//TODO: I can create a setDriver method inside maze controller to set the driver
